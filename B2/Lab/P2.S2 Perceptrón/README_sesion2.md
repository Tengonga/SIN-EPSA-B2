...
A modo de ejemplo, se proporciona un [cuaderno Jupyter](01_iris_perceptron.ipynb) con una implementación sencilla del algoritmo Perceptrón y su
...
1. Analizar, ejecutar y completar el [cuaderno del perceptrón aplicado al corpus Iris](01_iris_perceptron.ipynb), para obtener la menor tasa de error posible en test.
